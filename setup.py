...
setup(name='ploverdm',
      ...
      license=__license__,
      author='Peter Garas',
      author_email='garas.peter@gmail.com',
      maintainer='Peter Garas',
      maintainer_email='garas.peter@gmail.com',
      packages=['plover', 'plover.machine', 'plover.gui', 'plover.oslayer', 'dictionarymanager', 'dictionarymanager.store', 'dictionarymanager.gui', 'dictionarymanager.gui.widget'],
      package_data={'plover' : ['assets/*']},
      data_files=[('/usr/share/applications', ['application/Plover.desktop']),
                  ('/usr/share/pixmaps', ['plover/assets/plover_on.png']),],
      scripts=['application/ploverdm'],
      requires=['serial', 'Xlib', 'wx', 'appdirs'],
      platforms=['GNU/Linux'],
      classifiers=['Programming Language :: Python',
                   'License :: OSI Approved :: GNU General Public License (GPL)',
